...
"""
Other options: SRU -- https://github.com/asappresearch/sru, pip install sru
"""
...
class QRNNLayer(nn.Module):
    def __init__(self, input_size, hidden_size, kernel_size, use_attn=False):
        ...
        # quasi_conv_layer
        self.conv1d = nn.Conv1d(in_channels=input_size, out_channels=3*hidden_size, kernel_size=kernel_size)
